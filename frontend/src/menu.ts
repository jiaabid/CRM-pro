...
// console.log(can('canView','user'),'in menu vs')
...
export const Project = (can: any) => {
	return {
		...
		Module: {
			...
			path: '/Module',
			icon: 'Window',
			hide: !can('canView', 'module'),
			subMenu: {
				ModuleCreation: {
					id: 'ModuleCreation',
					text: 'Module Creation',
					path: '/Module/ModuleCreation',
				...
				ModuleConfiguration: {
					...
					path: '/Module/ModuleConfiguration',
					icon: 'Dvr',
					hide: !can('canView', 'module')
				},
			},
